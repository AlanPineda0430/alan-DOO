package co.edu.uco.grades.businesslogic.bussiness.facade.impl;
...
public class IdTypeFacadeImpl<IdTypeBusiness> implements IdTypeFacade {
	...
	public void create(IdTypeDTO dto) throws Exception {
		...
		try {
			...
			IdTypeBusines idTypeBussiness = new IdTypeBusinessImpl(daoFactory);
	...
	public void update(IdTypeDTO dto) throws Exception {
		...
		try {
			...
			daoFactory.initTransaction();
			// Ejecutar el negocio
			IdTypeBusiness idTypeBussiness = (IdTypeBusiness) new IdTypeBusinessImpl(daoFactory);
